 ...
 * files each line of the format <A1;A2;.....;A12>, and produces
 * <<A1;A2;..;A11>,A12> as Map output. The Reduce output is a list of all
 * candidates for the self join common items
 * 
 * 
 * To run: bin/hadoop jar build/hadoop-examples.jar selfjoin [-m <i>maps</i>]
