...
public class FlowSchedulerNode extends SchedulerNode {
  ...
  public FlowSchedulerNode(RMNode node, boolean usePortForNodeName,
  ...
  public boolean isAvailable() {
    return getAvailableResource().getMemory() / this.slotSize > 0;
  }

  public boolean isAvailable(Resource requiredResource) {
    return getAvailableResource().getMemory() >= requiredResource.getMemory();
  }
