...
public class FlowSchedulerInfo extends SchedulerInfo {
  ...
  public FlowSchedulerInfo() {
  } // JAXB needs this

  public FlowSchedulerInfo(final ResourceManager rm) {

    RMContext rmContext = rm.getRMContext();

    FlowScheduler fs = (FlowScheduler) rm.getResourceScheduler();
