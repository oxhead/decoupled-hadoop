...
class FlowSchedulerPage extends RmView {
  ...
  static class QueuesBlock extends HtmlBlock {
    final FlowSchedulerInfo sinfo;
    final FlowScheduler fs;

    @Inject QueuesBlock(ResourceManager rm) {
      sinfo = new FlowSchedulerInfo(rm);
      fs = (FlowScheduler) rm.getResourceScheduler();
    }
      ...
      UL<DIV<DIV<Hamlet>>> ul = html.
        div("#cs-wrapper.ui-widget").
          div(".ui-widget-header.ui-corner-top").
            _(fs.getClass().getSimpleName() + " Queue")._().
